...
<?php
    ...
    $from = 'From: noreply@elementaryweb.com.au'; 
    $to = 'kinshuksen@gmail.com'; 
    $subject = 'Contact Us - ElementaryWeb';
                ...
                <div class="col-lg-12">
                    <form name="sentMessage" id="contactForm" method="post" action="index.php" novalidate>
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
                                <button type="submit" id="submit" name="submit" class="btn btn-xl">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
